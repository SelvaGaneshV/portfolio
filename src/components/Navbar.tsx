...
function Navbar() {
  ...
  return (
    <div className="sticky hidden sm:flex top-0 right-0 left-0 z-50  justify-center px-3 pt-3 sm:px-6 sm:pt-8">
      <header className="w-full max-w-3xl xl:max-w-5xl 2xl:max-w-6xl">
        <div className="mx-auto flex w-full gap-3 rounded-full border border-accent/50 px-2 py-2 shadow-2xl shadow-black/40 backdrop-blur-md transition-all duration-300 hover:border-accent hover:bg-background/45 hover:shadow-black/60 sm:w-fit sm:px-6 sm:py-3">
